...
#find the continents with only countries with less than 25 mil

#continent where every country has a population less than 25mil
#list those countries
#countries
# => continent
# ==> all countries have pop < 25 mil